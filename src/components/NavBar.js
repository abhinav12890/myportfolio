...
const Navbar = () => {
    ...
    return (
        <header
            className="w-full px-32 py-8 fpnt-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8"
        >
            ...
            <div className="w-full flex justify-between items-center lg:hidden">
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    ...
                    <motion.a href='https://github.com/abhinav12890' target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3"><GithubIcon /></motion.a>
                    <motion.a href='https://www.linkedin.com/in/abhinav-kumar-366911205/' target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3"><LinkedInIcon /></motion.a>
                    {/* <motion.a href='/' target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 dark:bg-light rounded-full"><PinterestIcon /></motion.a> */}
                ...
                isOpen ?
                    <motion.div initial={{ scale: 0, opacity: 0, x: "-50%", y: "-50%" }} animate={{ scale: 1, opacity: 1 }} className="min-w-[70vw] flex flex-col justify-between z-30 items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32">
                        ...
                        <nav className="flex items-center justify-center flex-wrap mt-2">
                            ...
                            <motion.a href='https://github.com/abhinav12890' target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1 bg-light rounded-full dark:bg-dark"><GithubIcon /></motion.a>
                            <motion.a href='https://www.linkedin.com/in/abhinav-kumar-366911205/' target={'_blank'} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mx-3 sm:mx-1"><LinkedInIcon /></motion.a>
